...
(function () {
    ...
    function enhanceRows(tbody) {
        ...
        rows.forEach((row) => {
            ...
            const descText = (_b = (_a = allTds[1]) === null || _a === void 0 ? void 0 : _a.textContent.trim()) !== null && _b !== void 0 ? _b : '';
            ...
            const crcText = (_d = (_c = allTds[2]) === null || _c === void 0 ? void 0 : _c.textContent.trim()) !== null && _d !== void 0 ? _d : '';
            const usdText = (_f = (_e = allTds[3]) === null || _e === void 0 ? void 0 : _e.textContent.trim()) !== null && _f !== void 0 ? _f : '';
            ...
            const occurrence = (_g = occurrenceCounts.get(baseId)) !== null && _g !== void 0 ? _g : 0;
